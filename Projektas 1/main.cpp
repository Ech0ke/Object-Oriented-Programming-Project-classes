...
int main()
{
    ...
    {
        Studentas* mas = new Studentas[s]; //sukuriamas dinaminis masyvas studentams saugoti
        for (int i = 0; i < s; i++)
        {
            ivestis(mas[i]); //perduodami studento duomenys i ivesties funkcija
        }
        for (int i = 0; i < s; i++)
        {
            vidurkis(mas[i]); //skaiciuojamas studento vidurkis
            mediana(mas[i]); //skaiciuojamas studento vidurkis, naudojant mediana
        }
